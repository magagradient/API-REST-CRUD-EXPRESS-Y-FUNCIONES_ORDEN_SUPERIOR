...
const paises = JSON.parse(fs.readFileSync(path.join(__dirname, 'paises.json'), 'utf8'));
...
app.post("/paises", (req, res) => {
    ...
    fs.writeFileSync(path.join(__dirname, 'paises.json'), JSON.stringify(paises), 'utf-8');
